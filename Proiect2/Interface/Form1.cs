...
namespace Interface
{
    public partial class Form1 : Form
    {
        ...
        private void uploadButton_Click(object sender, EventArgs e)
        {
            ...
            result.Filter = "Image Files | *.jpg; *.jpeg; *.jpe; *.jfif; *.png ;*.PNG;| Video files |*.wav;*.aac;*.wma;*.wmv;" +
                "*.avi;*.mpg;*.mpeg;*.m1v;*.mp2;*.mp3;*.mpa;*.mpe;*.m3u;*.mp4;*.mov;*.3g2;*.3gp2;*.3gp;*.3gpp;*.m4a;*.cda;" +
                "*.aif;*.aifc;*.aiff;*.mid;*.midi;*.rmi;*.mkv;*.WAV;*.AAC;*.WMA;*.WMV;*.AVI;*.MPG;*.MPEG;*.M1V;*.MP2;*.MP3;" +
                "*.MPA;*.MPE;*.M3U;*.MP4;*.MOV;*.3G2;*.3GP2;*.3GP;*.3GPP;*.M4A;*.CDA;*.AIF;*.AIFC;*.AIFF;*.MID;*.MIDI;*.RMI;*.MKV";
